    ...
    <div className="contact-page">
      ...
      <div className="contact-page-container">
        ...
        <div className="address">
            <p><b>Address:</b> 4491 Slanting Bridge Road, Sherrills Ford, 28673</p>
            <p><b>Phone Number:</b> (828) - 478 - 5944</p>
            <p><b><u>Hours of Operation:</u></b></p>
            <ul className="hours">
              <li><b><i>Monday - Tuesday:</i></b> Closed</li>
              <li><b><i>Wednesday - Saturday:</i></b> 11AM - 9PM</li>
              <li><b><i>Sunday:</i></b> 11AM - 8PM</li>
            </ul>
          </div>
          <iframe
